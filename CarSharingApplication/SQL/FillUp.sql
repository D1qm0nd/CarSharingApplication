...
GO
	...
	(4234, 123343,	1	,'52LD5432123',   	'О435РУ777', 	'MERCEDES-BENZ',	'Gelandewagen',	'Внедорожник',	'B',	2021,	'NO',	'2342342341',	'Черный',		200,	'Четвёртый',  1200,	1100),
	(2343, 423423,	2	,'43MK3244212',   	'А435КА047', 	'LADA',				'Kalina',		'Седан',		'B',	2011,	'NO',	'234SDF2341',	'Синий',		120,	'Четвёртый',  1200,	1100),
	(6432, 234212,	3	,'54TY4321134',   	'Л834РС777', 	'KIA',				'RIO',			'Седан',		'B',	2021,	'NO',	'234SDF2341',	'Белый',		120,	'Четвёртый',  1200,	1100),
	(1243, 435344,	4	,'12HR6573423',   	'В888ВВ888', 	'Lamborghini ',		'Aventador',	'Спортивная',	'B',	2014,	'NO',	'435423FD342',	'Оранжевый',	450,	'Четвёртый',  1200,	1100),
	(3452, 123412,	5	,'52HJ5652523',   	'А555АА052', 	'MERCEDES-BENZ',	'C-CLASS',		'Седан',		'B',	2021,	'NO',	'2342342341',	'Серый',		200,	'Четвёртый',  1200,	1100),
	(5476, 452323,	6	,'42MK3244212',   	'С347БА112', 	'LADA',				'Granta',		'Седан',		'B',	2021,	'NO',	'234SDF2341',	'Коричневый',	120,	'Четвёртый',  1200,	1100),
	(1234, 123124,	7	,'52TY5321334',   	'Р333УС321', 	'LADA',				'Riva',			'Седан',		'B',	2021,	'NO',	'234SDF2341',	'Вишневый',		120,	'Четвёртый',  1200,	1100),
	(1443, 173412,	8	,'12HR6523223',   	'Н123НН123', 	'Lamborghini ',		'Gollardo',		'Спортивная',	'B',	2011,	'NO',	'435423FD342',	'Белый',		450,	'Четвёртый',  1200,	1100),
	(4313, 435123,	9	,'23HG5324143',   	'О435РП542', 	'SKODA',			'OCTAVIA II',	'Седан',		'B',	2021,	'NO',	'2342342341',	'Белый',		200,	'Четвёртый',  1200,	1100),
	(5674, 324344,	10	,'43DF2345243',   	'С435ВК047', 	'RENAULT',			'SCÉNICII',		'Седан',		'B',	2011,	'NO',	'234SDF2341',	'Коричневый',	120,	'Четвёртый',  1200,	1100),
	(3245, 763456,	11	,'52TY4321234',   	'У834КО777', 	'BMW',				'X1 (E84)',		'Седан',		'B',	2021,	'NO',	'234SDF2341',	'Белый',		120,	'Четвёртый',  1200,	1100),
	(1234, 123445,	12	,'12HR6573523',   	'К888ТО888', 	'SKODA ',			'KODIAQ',		'Внедорожник',	'B',	2014,	'NO',	'435423FD342',	'Белый',		450,	'Четвёртый',  1200,	1100),
	(3244, 342553,	13	,'51LD5432123',   	'В555СТ052', 	'OPEL',				'ASTRA',		'Седан',		'B',	2021,	'NO',	'2342342341',	'Серый',		200,	'Четвёртый',  1200,	1100),
	(5234, 143322,	14	,'43MK3243452',   	'С347УВ112', 	'TOYOTA',			'HILUX VII',	'Седан',		'B',	2021,	'NO',	'234SDF2341',	'Серый',		120,	'Четвёртый',  1200,	1100),
	(3242, 423521,	15	,'54TY4321234',   	'О333КУ321', 	'MERCEDES-BENZ',	'E-CLASS',		'Седан',		'B',	2021,	'NO',	'234SDF2341',	'Серебристый',	120,	'Четвёртый',  1200,	1100),
	(3544, 643422,	16	,'43HY1123423',   	'Н123ТК123', 	'Porsche  ',		'Cayenne',		'Внедорожник',	'B',	2011,	'NO',	'435423FD342',	'Синий',		450,	'Четвёртый',  1200,	1100)
...
GO
	...
	('3317733078', 1,	GETDATE(), '19:49:47', 3,	414.9,		'стандартная'),
	...
	('2004572607', 13,	GETDATE(), '05:39:43', 10,	389.14,		'стандартная'),
	...
	('2367355897', 2,	GETDATE(), '18:23:25', 3,	431.43,		'стандартная'),
	('4531785002', 4,	GETDATE(), '04:53:11', 13,	312.6,		'досрочная'),
	('3917476879', 7,	GETDATE(), '13:36:39', 1,	156.7,		'стандартная'),
	('5646226654', 1,	GETDATE(), '22:54:20', 9,	523.06,		'стандартная'),
	('8949489429', 3,	GETDATE(), '15:31:20', 1,	354.46,		'стандартная'),
	('0803883483', 8,	GETDATE(), '11:26:37', 9,	594.67,		'досрочная'),
	('0400226437', 15,	GETDATE(), '22:04:52', 7,	650.58,		'стандартная'),
	('1185992697', 6,	GETDATE(), '12:29:47', 2,	291.64,		'стандартная'),
	('0935049134', 5,	GETDATE(), '22:05:19', 11,	436.33,		'стандартная'),
	('1465177079', 9,	GETDATE(), '11:07:07', 8,	280.58,		'стандартная'),
	...
	('5030944030', 4,	GETDATE(), '18:31:57', 9,	570.14,		'стандартная'),
...
GO
	...
	('Возгарание транспортного средства'),
	('Прочие происшествия')
